...
const SuperWrapper = styled.main`
...
const CrewAndSim = styled.section`
  display: flex;
  flex-direction: row;
  flex-wrap: wrap;
  justify-content: space-evenly;
            ...
            <>
              ...
              <Helmet
                ...
                meta={[
                  ...
                  {
                    name: 'og:url',
                    content: `https://videohead.netlify.app/data.detail/${type}/${id}`,
                  },
                  {
                    name: 'og:description',
                    content: data.detail.overview,
              ...
              <SecondaryInformation>
                {data.credits.cast.length > 0 && (
                  <>
                    ...
                    <CastOverview>
                      {data.credits.cast.slice(0, 6).map(member => member.profile_path ? (
                ...
                <CrewAndSim>
                  {data.credits.crew.length > 0 && (
                    <CrewOverview>
                      <h2>Featured Crew</h2>
                      {data.credits.crew.slice(0, 6).map(member => (
                  ...
                  <SimOverview>
                    ...
                    {data.similar.slice(0, 6).map(item => (
...
DetailedView.propTypes = {
  type: PropTypes.oneOf(['movie']).isRequired,
  id: PropTypes.string,
}
